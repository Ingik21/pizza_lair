...
INSERT INTO pizza_menupizzas (name,description,toppings_id,base_price,on_sale) VALUES ('Margherita','Tomato sauce, mozzarella cheese',24,1000,false);
INSERT INTO pizza_menupizzas (name,description,toppings_id,base_price,on_sale) VALUES ('Hawaiian','Tomato sauce, mozzarella cheese, ham, pineapple',9,1200,false);
INSERT INTO pizza_menupizzas (name,description,toppings_id,base_price,on_sale) VALUES ('Pepperoni','Tomato sauce, mozzarella cheese, pepperoni',1,1300,false);

INSERT INTO pizza_pizzaimage (image,pizza_id) VALUES ('https://pizza.az/upload/iblock/cb0/cb0abb92f9b512713c74bf03dbb70723.jpg',1);
INSERT INTO pizza_pizzaimage (image,pizza_id) VALUES ('https://pizza.az/upload/iblock/f4f/f4f3e2cce270517c62adbd4ae6a95656.jpg',2);
INSERT INTO pizza_pizzaimage (image,pizza_id) VALUES ('https://pizza.az/upload/iblock/809/80956e09d302a120d49b6fd1071fe5b7.jpg',3);

INSERT INTO user_user (name,member_since,image,email,password,favorite_pizza_id) VALUES ('John Doe','2020-01-01','https://randomuser.me/api/portraits/men/93.jpg','johndoe@gmail.com','123456',1);
INSERT INTO user_user (name,member_since,image,email,password,favorite_pizza_id) VALUES ('Jane Doe', '2002-02-02','https://randomuser.me/api/portraits/women/92.jpg','jane@yahoo.co.uk','123456',2);
INSERT INTO user_user (name,member_since,image,email,password,favorite_pizza_id) VALUES ('Juan Jose', '2001-09-11','https://randomuser.me/api/portraits/lego/6.jpg','juan@doe.is','123456',3);
